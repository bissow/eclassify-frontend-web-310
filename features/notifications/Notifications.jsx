...
import { getNotificationList } from "@/lib/api";
            ...
            >
              ...
              <div className="flex flex-1 justify-between gap-2 min-w-0">
                <div className="flex flex-col gap-0.5 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground wrap-break-word">{notification.message}</p>
                </div>
                <span className="text-xs text-muted-foreground whitespace-nowrap shrink-0">
                  {formatDateMonthYear(notification.created_at, langCode)}
                </span>
              </div>
            </div>
          ))}
