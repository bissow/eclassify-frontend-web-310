...
import AdsCard from "@/features/listing/manage/MyAdsCard.jsx";
import { deleteItemApi, getMyItemsApi } from "@/lib/api";
...
const MyAds = () => {
  ...
  return (
    <>
      <div className="hidden md:flex flex-col gap-2 md:flex-row md:items-center md:justify-between py-2 px-4 bg-muted rounded-lg">
      ...
      {expiredAds.length > 0 && (
        <div className="mt-7.5 text-sm text-destructive">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 mt-7.5 xl:grid-cols-3 gap-3 sm:gap-6">
        {IsLoading ? (
