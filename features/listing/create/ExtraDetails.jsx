import CustomFieldCombobox from "@/components/common/CustomFieldCombobox";
...
import NoTranslatableFields from "@/components/empty-states/NoTranslatableFields";
...
const ExtraDetails = ({
  ...
  const isNonDefaultLang = langId !== defaultLangId;
  const hasNoTranslatableFields = isNonDefaultLang && !customFields.some(f => f.type === "textbox");
          ...
          <div className="flex flex-col">
            <Input
              ...
              onChange={(e) => {
                ...
                handleChange(id, max_length ? val.slice(0, max_length) : val);
              }}
  ...
  return (
    <div className="flex flex-col gap-8">
      {hasNoTranslatableFields ? (
        <NoTranslatableFields />
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {customFields?.map((field) => {
            if (isNonDefaultLang && field.type !== "textbox") return null;
