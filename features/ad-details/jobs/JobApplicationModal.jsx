...
import { getAdJobApplicationsApi } from "@/lib/api";
import NoData from "@/components/empty-states/NoData";
import JobApplicationCard from "@/features/ad-details/jobs/JobApplicationCard";
import JobApplicationCardSkeleton from "@/features/ad-details/jobs/JobApplicationCardSkeleton";
        ...
        <ScrollArea className="h-[60vh] pr-4">
          <div className="space-y-4">
            {receivedApplications.isLoading ? (
              ...
              <NoData title={t("noJobApplicationsFound")} />
            )}
          </div>
