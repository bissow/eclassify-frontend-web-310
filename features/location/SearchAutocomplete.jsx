import { saveCity } from "@/lib/location";
import { getIsPaidApi } from "@/store/slices/settingSlice";
import { useTranslation } from "@/lang/useTranslation";
import { getLocationApi } from "@/lib/api";
        ...
        >
          ...
          {autoState.show &&
            (autoState.suggestions.length > 0 || autoState.loading) && (
              <CommandList className="absolute top-full left-0 right-0 z-1500 max-h-55 overflow-y-auto rounded-lg border bg-white shadow-lg">
                {autoState.loading && (
